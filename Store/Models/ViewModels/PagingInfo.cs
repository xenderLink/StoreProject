...
public class PagingInfo
{
    ...
    (int) Math.Ceiling( (decimal)TotalProducts/ProductsPerPage); //Всего страниц = Количество продуктов/Количество продуктов на страничке
    public static int TotalPages(int TotalProducts, int ProductsPerPage) =>     
